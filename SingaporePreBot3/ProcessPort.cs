...
namespace SingaporePreBot3
{
        ...
        private static List<ProcessPort> GetNetStatPorts()
        {
            ...
            try
            {
                using (Process Proc = new Process())
                {
                    ...
                    string NetStatContent = StandardOutput.ReadToEnd();
    ...
    public class ProcessPort
    {
        ...
        internal ProcessPort(int ProcessId, string Protocol, int PortNumber)
        {
